...
#ifndef FRACTAL_MULTICLASSIFPROBEWORD_H_
#define FRACTAL_MULTICLASSIFPROBEWORD_H_
...
class MultiClassifProbeWord : public TrainableProbe
{
public:
    MultiClassifProbeWord();

    void SetOOVNum(INT InOOVNum);
...
#endif /* FRACTAL_MULTICLASSIFPROBEWORD_H_ */
